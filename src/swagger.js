...
- \`errors\`:
  - If present with value \`Y\`, the response will be an HTTP error.
  - If present with value \`N\`, the response won't generate an HTTP error.
  - If not present, the response will randomly generate an HTTP error
`
